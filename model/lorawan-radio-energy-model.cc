...
void
LoRaWANRadioEnergyModel::ChangeLoRaWANState (LoRaPhy::State oldState, LoRaPhy::State newState)
{
...
void
LoRaWANRadioEnergyModel::SetLoRaWANRadioState (const LoRaPhy::State state)
{
