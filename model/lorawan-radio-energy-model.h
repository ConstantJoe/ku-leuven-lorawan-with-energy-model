...
public:
   ...
   */
  LoRaPhy::State GetCurrentState (void) const; //Note: type of this depends on LoRaWAN module used.
   ...
   */
  virtual void ChangeLoRaWANState (LoRaPhy::State oldState, LoRaPhy::State newState);
...
private:
   ...
   */
  void SetLoRaWANRadioState (const LoRaPhy::State state);
