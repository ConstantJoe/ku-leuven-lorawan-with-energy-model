                                       ...
                                       Ptr<EnergySource> source) const
{
  ...
  Ptr<LoRaNetDevice> LoRaWANDevice = DynamicCast<LoRaNetDevice> (device);
  Ptr<LoRaPhy> LoRaWANPhy = LoRaWANDevice->GetPhy ();
  ...
  LoRaWANPhy -> TraceConnectWithoutContext ("StateValue",MakeCallback(&LoRaWANRadioEnergyModel::ChangeLoRaWANState, model));
  LoRaWANPhy -> TraceConnectWithoutContext ("TxPower",MakeCallback(&LoRaWANRadioEnergyModel::SetTxCurrentA, model));
  LoRaWANPhy -> TraceConnectWithoutContext ("Bandwidth",MakeCallback(&LoRaWANRadioEnergyModel::SetRxCurrentA, model));
